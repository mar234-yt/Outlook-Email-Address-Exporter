...
9. БЕЛЕЖКИ
----------
- PST файловете са изключени от Git чрез .gitignore, тъй като са
  големи двоични файлове и могат да съдържат чувствителни данни.
- Примерният addresses_clean.csv е демонстрационен изход и може да
  бъде изтрит преди тестване с реални данни.
